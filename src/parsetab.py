...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','mypar.py',22),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','mypar.py',26),
  ('expression -> term','expression',1,'p_expression_term','mypar.py',30),
  ('term -> term TIMES factor','term',3,'p_term_times','mypar.py',34),
  ('term -> term DIVIDE factor','term',3,'p_term_div','mypar.py',38),
  ('term -> factor','term',1,'p_term_factor','mypar.py',42),
  ('factor -> NUMBER','factor',1,'p_factor_num','mypar.py',46),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','mypar.py',50),
]
